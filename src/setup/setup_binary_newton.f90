...
subroutine setpart(id,npart,npartoftype,xyzh,massoftype,vxyzu,polyk,gamma,hfact,time,fileprefix)
 ...
 use units,     only:set_units,umass,udist,unit_density,unit_velocity,get_c_code
...
!
 ...
 print*,umass,"umass",udist,"udist",unit_velocity,"unit_velocity"
